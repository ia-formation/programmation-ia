...
class QEFormat(QuestionFormat):
    ...
    def generate_question(self):
        ...
        return Question("Quel est le résultat de cette expression ?"
        ...
        for question_number, question in enumerate(questions):
            ...
            while unsolved:
                ...
                if question.is_correct_answer(guess):
                    ...
                    print("Déterminez pourquoi c’est le cas avant de continuer !")
                    #print("Please type 'I understand' (without quotes) to continue.")
                    print("Veuillez saisir 'Je comprends' (sans les guillemets) pour continuer.")
                    busywork = input(">>>")
